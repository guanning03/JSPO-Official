#!/bin/bash
#SBATCH --job-name=RLOO-7B-DAPO-N24-offload       # Job name
#SBATCH --output=./logs/RLOO-7B-DAPO-N24-offload_%j.out  # Output file (%j will be replaced by job ID)
#SBATCH --error=./logs/RLOO-7B-DAPO-N24-offload_%j.err   # Error file
...
project_name='DAPO'
exp_name='7B-Math-RLOO-dataDAPO-N24-offload'
